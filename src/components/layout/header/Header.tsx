...
export default function Header() {
  ...
  return (
    <header className="w-full flex flex-col">
      {!accessToken && (
        <div className="body-b1-sb flex justify-end pb-0 py-[0.75rem] pr-[2rem] gap-[2.75rem]">
          <Link to="/signup" className="cursor-pointer">
            회원가입
          </Link>
          <Link to="/login/type" className="cursor-pointer">
            로그인
          </Link>
        </div>
      )}

      <div className="h-22 flex items-center ml-[3.125rem] mr-[2rem]">
        <Link to="/home" className="w-[191px] h-[44.6px] mr-[2.19rem]">
          <img
            src={logo}
            alt="logo"
                  ...
                  <div className="pt-[0.875rem] px-[1rem]">
                    ...
                    <div className="px-[1.25rem]">
                      <button
                        ...
                        className="body-b1-md w-full text-left px-2 py-[1.125rem]"
                      >
                        내 정보
                      </button>
                      <button
