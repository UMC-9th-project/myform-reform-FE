...
export const CARDCLASSES =
  'w-[297px] h-[321px] PX-[2.3125rem] py-[2.25rem] flex flex-col gap-[0.625rem] rounded-[1.25rem] bg-[var(--color-gray-20)] border border-[var(--color-gray-20)] hover:bg-[var(--color-white)] hover:border-[var(--color-black)] hover:shadow-[0_4px_15.4px_0_rgba(0,0,0,0.09)] transition-all duration-200 cursor-pointer' as const;
