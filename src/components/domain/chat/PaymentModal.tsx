...
const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  const isFormValid =
    price.trim() != '' && delivery.trim() !== '' && days.trim() !== '';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-8">
      <div className="bg-white mr-5 rounded-[2rem] w-[45rem] relative shadow-xl">
        ...
        <div className="pt-5 px-8">
          ...
          <p className="body-b1-rg text-[var(--color-gray-60)] mb-2">
            아래 결제 요청 내용을 확인해주세요.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="flex-1">
                <label className="block heading-h5-sb text-[var(--color-gray-60)] mb-2">
                  예상 가격
                </label>
