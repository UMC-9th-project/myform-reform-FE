...
const EstimateArriveCard: React.FC<ArriveCardProps> = ({
  type,
  onReject,
  onAccept,
}) => {
  ...
  return (
    ...
    >
      {/* 4. 결제 카드 본체 */}
      <div
        className={`${bgColor} ${borderRadiusClass} pb-0 p-5 min-w-[23rem] shadow-sm`}
      >
        <h2 className="heading-h5-sb mb-3 text-black">
          새로운 견적서가 도착했어요!
        </h2>
        ...
        <p className="text-[0.8125rem] font-regular text-[#646F7C] pb-4 text-center">
          추가 문의하기를 통해 리폼러와 견적 상담을 진행할 수 있습니다.
        </p>
      </div>
    </div>
  );
