...
const OrderDetail = () => {
  // 상태 관리
  const [status, setStatus] = useState('상태 없음');
        ...
        <section>
          ...
          <div className="flex gap-6">
            ...
            <div className="w-35 h-36 bg-gray-100 flex-shrink-0 overflow-hidden">
              <img 
                src="https://via.placeholder.com/160x150" 
                alt="상품 이미지" 
            ...
            <div className="flex-1 flex flex-col gap-3">
              <h4 className="body-b0-md text-black leading-tight">
                이제는 유니폼도 색다르게! 한화·롯데 등 야구단 유니폼 리폼해드립니다.
              </h4>
              ...
              <div className="grid grid-cols-[80px_1fr] text-[15px] gap-y-2 gap-x-4">
                ...
                <span className="text-black body-b0-rg">75,000원</span>

                <span className="body-b0-rg text-[var(--color-gray-50)]">옵션</span>
                <span className="text-black body-b0-rg">옵션 1</span>
                
                <span className="body-b0-rg text-[var(--color-gray-50)]">결제일시</span>
                <span className="body-b0-rg text-[var(--color-gray-50)]">2025. 10. 14. 23:45:23</span>
              </div>
            </div>
          </div>
        </section>
                        ...
                        {statusOptions.map((option) => (
                          ...
                          >
                            ...
                            <div className={`w-5 h-5 rounded-full border flex items-center justify-center transition-all
                              ${status === option ? 'border-black' : 'border-gray-300'}`}
                            >
                              {status === option && (
                            ...
                            {/* 텍스트 */}
                            <span className={`body-b1-sb ${status === option ? 'text-black' : 'text-gray-600'}`}>
                              {option}
                            </span>
                          </li>
                        ))}
